...
from .extract_legal_entities import Prompt as ExtractLegalEntitiesPrompt
from .extract_legal_entities import Versions as ExtractLegalEntitiesVersions
from .extract_legal_entities import versions as extract_legal_entities_versions
...
class PromptLibrary(Protocol):
    ...
    eval: EvalPrompt
    extract_legal_entities: ExtractLegalEntitiesPrompt
...
class PromptLibraryImpl(TypedDict):
    ...
    eval: EvalVersions
    extract_legal_entities: ExtractLegalEntitiesVersions
...
PROMPT_LIBRARY_IMPL: PromptLibraryImpl = {
    ...
    'eval': eval_versions,
    'extract_legal_entities': extract_legal_entities_versions,
}
